function [Feret, Curvature2, u_sol_best] = Length_Curv_2Feret(Length, Curvature, constants, check_intersections, do_width_correction)
...
[R,xcyc] = fit_circle_through_3_points([    [x' y'] ;  midpt ]);
