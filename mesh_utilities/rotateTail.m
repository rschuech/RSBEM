function [Mesh, mesh_node_parameters] = rotateTail(Mesh, mesh_node_parameters,index_mapping,tail_ind, angle)
...
% to allow for tails located and oriented anywhere, we first shift to origin, rotate, then shift back
    ...
    [Mesh, mesh_node_parameters] = rotateMesh(Mesh,mesh_node_parameters,index_mapping,tail_ind, angle  ,   Mesh(tail_ind).orientation(:,1) );
