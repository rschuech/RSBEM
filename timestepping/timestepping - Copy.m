...
[timestepping_solution.x, timestepping_solution.y] = ...
    ode45(fun,[0 input.accuracy.timestepping.Tmax],dump.y0,odeset('InitialStep',input.accuracy.timestepping.initialstep,'reltol',input.accuracy.timestepping.reltol,'abstol',input.accuracy.timestepping.abstol));
...
save([input.paths.dumpfolder,input.paths.namebase.full,'_timestepping','.mat'],'timestepping_solution','timings');
