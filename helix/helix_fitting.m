...
for T = fits.T
    ...
    if c >= 3
        [fits] = check_convergence(fits, diff_cutoff_1,min_R2);
...
[fits] = check_convergence(fits, diff_cutoff_2,min_R2);
if ~isnan(fits.converged.speed)
    return
end

[fits] = check_convergence(fits, diff_cutoff_3,min_R2);
if ~isnan(fits.converged.speed)
    return
end
...
%%
function [fits] = check_convergence(fits,diff_cutoff,min_R2)
