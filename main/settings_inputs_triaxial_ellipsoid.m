...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.datfolder = 'C:\Users\rudi\Desktop\RD\convergence_meshes\';   %location of .dat T6 mesh file(s)
        ...
        inputs.paths.results_file = 'triaxial_ellipsoid_Results.mat';
        ...
        inputs.paths.lock_file = 'convergence_lock'; % to avoid race condition between racks when writing to shared Results file
        ...
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\convergence_dumps\';
...
switch inputs.bugtype
    case 'bacteria'
        load(['../sweeps/','ellipsoid_sweep.mat']);  %contains all new AR1, AR2, amp, lambda, nlambda
    case {'dino', 'sheet'}
