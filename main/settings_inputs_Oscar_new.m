...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.datfolder = 'C:\Users\rudi\Desktop\RD\Oscar new meshes\experiment 8\';   %location of .dat T6 mesh file(s)
        ...
        inputs.paths.results_file = 'Oscar experiment 8.mat';
        ...
        inputs.paths.lock_file = 'Oscar_lock'; % to avoid race condition between racks when writing to shared Results file
        ...
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\Oscar dumps\experiment 8\';
        %          inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\dino_dumps\';
end

sweep_file = 'Oscar experiment 8 sweep.mat';
...
switch inputs.bugtype
    case 'bacteria'
        load(['../sweeps/',sweep_file]);  %contains all new AR1, AR2, amp, lambda, nlambda
%         new_sweep.AR1 = 5; new_sweep.AR2 = 0.5; new_sweep.amp = 0.5; new_sweep.lambda = 3.5;  new_sweep.nlambda = 1.4;
    case {'dino', 'sheet'}
...
switch getenv('computername')
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        inputs.performance.nthreads = 15; %feature('numCores');  %number of threads for parallelization
end
...
%     inputs.body.sphererad = (inputs.body.V*3/4/pi)^(1/3);
    ...
    if inputs.include_tail
        ...
        inputs.tail.motor_freq = 910 *2*pi ;  %rad / sec
...
for i = 1:length(Inputs)
    switch inputs.bugtype
        case 'bacteria'
            ...
            Inputs(i).paths.namebase.body = [Inputs(i).body.shape,'_AR1_',num2str(Inputs(i).body.AR(1),digits),'_AR2_',num2str(Inputs(i).body.AR(2),digits),Inputs(i).body.suffix];
