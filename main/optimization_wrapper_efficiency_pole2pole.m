function [power_eff] = optimization_wrapper_efficiency_pole2pole(AR1,AR2,Amp,Lambda,Nlambda ,results_file, lock_file_name, results_file_name , sweep_tempfile, dump_folder)
...
settings_inputs_pole2pole_efficiency;
