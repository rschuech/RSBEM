...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        rack = getenv('computername');
        inputs.paths.rack = rack;
        inputs.paths.results_folder = 'C:\Users\rudi\Desktop\RD\Chemotactic_SNR_tail_length\';
        inputs.paths.results_file = 'Results_lambda.mat';
        ...
        inputs.paths.lock_file = 'lock_shat'; % to avoid race condition between racks when writing to shared Results file
        ...
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\Chemotactic_SNR_tail_length\';
...
%  new_sweep.nlambda = [1 1.5 2 2.5 3 3.5 4 4.5];  new_sweep.nlambda = 5; len = length(new_sweep.nlambda); 
 
new_sweep.lambda = [1 1.5 2 2.5 3 3.5 4 4.5]'; new_sweep.lambda = 5; len = length(new_sweep.lambda);  
new_sweep.nlambda = repmat(3.55,len,1);
% new_sweep.lambda = repmat(3.91,len,1);
new_sweep.AR1 = repmat(1,len,1); new_sweep.AR2 = repmat(0,len,1);
         new_sweep.amp = repmat(0.26,len,1); 
