...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.results_file = 'Results_straight_tail.mat';
        ...
        inputs.paths.lock_file = 'straight_lock'; % to avoid race condition between racks when writing to shared Results file
        ...
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\cleaner_straight_dumps\';
...
switch inputs.bugtype
    case 'bacteria'
        sweep_tempfile = 'new_sweep_straight_tail.mat';
