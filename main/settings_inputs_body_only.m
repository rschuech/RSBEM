...
%         inputs.paths.results_file = results_file_name;
          inputs.paths.results_file = 'Results_body_only.mat';
        ...
        inputs.paths.lock_file = 'body_only_lock'; % to avoid race condition between racks when writing to shared Results file
        ...
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\body_only_dumps\';
...
switch inputs.bugtype
    case 'bacteria'
        load(['../sweeps/','all_bodies.mat']);  %contains all new AR1, AR2, amp, lambda, nlambda
