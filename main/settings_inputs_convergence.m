...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.results_folder = 'C:\Users\rudi\Desktop\RD\Results\';
          inputs.paths.results_file = ['Results_convergence_max_rel_diff_0.5_reltols_1_timestepping_0.05.mat'];
...
switch inputs.bugtype
    case 'bacteria'
        load ../sweeps/convergence_sweep.mat  %contains all new AR1, AR2, amp, lambda, nlambda
    case {'dino', 'sheet'}
...
inputs.paths.suffix = '_max_rel_diff_0.5_reltols_1_timestepping_0.05';
...
inputs.accuracy.interpolation.max_iter = 7;  %max # adaptive interpolation iterations before giving up
