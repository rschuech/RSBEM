...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\efficiency_dumps_refined_test\';
        %          inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\dino_dumps\';
end


inputs.Fore_Aft_Override = false; % override avg_swimming_axis with those from optimized Temporal SN?  only use for Fore-Aft SN runs!  see Save_Results.m
inputs.Fore_Aft_Override_file = 'C:\Users\rudi\Desktop\RD\sweeps\avg_swimming_axes_for_Temporal_SN.mat'; % loads avg_swimming_axes with fields AR1_AR2 (Nx2) and avg_swimming_axis (Nx3)
