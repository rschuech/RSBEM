...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.results_file = 'Results.mat';
        ...
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\forced_dumps\';
...
switch inputs.bugtype
    case 'bacteria'
        load ../sweeps/forced_sweep.mat  %contains all new AR1, AR2, amp, lambda, nlambda
    case {'dino', 'sheet'}
...
inputs.accuracy.interpolation.max_rel_diff = Inf ;
