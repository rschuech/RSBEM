function [Temporal_SN] = optimization_wrapper_temporal_SN(AR1,AR2,Amp,Lambda,max_arclength ,results_file, lock_file_name, results_file_name , sweep_tempfile, dump_folder)
