...
%                 continue %with Inputs parameter sweep loop
        ...
        Mesh = rotateMesh(Mesh, [30 60 45]*pi/180);
        Mesh = shiftMesh(Mesh, [Metadata(1).geom.a Metadata(1).geom.b Metadata(1).geom.c]);
        Mesh.refpoints = [0 0 0]';  %need to hardcode since otherwise it will have moved with the rest of the mesh and remain the mesh centroid, which is boring
