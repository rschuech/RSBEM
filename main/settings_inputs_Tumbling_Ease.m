...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.results_file = 'Results_Tumbling_Ease.mat';
        ...
        inputs.paths.lock_file = 'Tumbling_lock'; % to avoid race condition between racks when writing to shared Results file
       ...
       % distcomp.feature( 'LocalUseMpiexec', false ); %fixes bug in parallel toolbox as of 2015a
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\Tumbling_dumps\';
        %          inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\dino_dumps\';
end


inputs.swimming_axis_override = true; % override avg_swimming_axis with those from optimized Temporal SN?  only use for Fore-Aft SN or Tumbling Ease runs!  see Save_Results.m
inputs.swimming_axis_override_file = 'C:\Users\rudi\Desktop\RD\sweeps\avg_swimming_axes_for_Temporal_SN_refined.mat'; % loads avg_swimming_axes with fields AR1_AR2 (Nx2) and avg_swimming_axis (Nx3)
...
switch inputs.bugtype
    case 'bacteria'
        load(['../sweeps/','sweep_Tumbling_Ease_refined.mat']);  %contains all new AR1, AR2, amp, lambda, nlambda
