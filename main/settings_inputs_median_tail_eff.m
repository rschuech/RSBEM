...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.results_file = 'Results_median_tail_eff.mat';
        ...
        inputs.paths.lock_file = 'Results_lock_eff'; % to avoid race condition between racks when writing to shared Results file
...
%         distcomp.feature( 'LocalUseMpiexec', false ); %fixes bug in parallel toolbox as of 2015a
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\median_tail_eff_dumps\';
...
switch inputs.bugtype
    case 'bacteria'
        load(['../sweeps/','median_obs_body_eff_opt_tail_sweep.mat']);  %contains all new AR1, AR2, amp, lambda, nlambda
