function [power_eff] = optimization_wrapper_redo_timestepping_medium(AR1,AR2,Amp,Lambda,Nlambda, results_file, lock_file_name, results_file_name , sweep_tempfile, dump_folder)
...
dump_dirs = [];  % to disable loading old dumps
...
for d = 1:length(dump_dirs)
    if exist([dump_dirs{d},dump_name],'file')
        ...
        input.accuracy.interpolation.max_iter = 2;
