...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.results_file = 'Results_shrunk_synced.mat';
        ...
        inputs.paths.lock_file = 'forced_lock_2'; % to avoid race condition between racks when writing to shared Results file
        ...
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\cleanest_forced_dumps\';
...
switch inputs.bugtype
    case 'bacteria'
        sweep_tempfile = 'sweep_CFD04.mat';
        load(['../sweeps/',sweep_tempfile]);  %contains all new AR1, AR2, amp, lambda, nlambda
        % directly loads new_sweep
%         new_sweep.AR1 = bodies(:,1);  new_sweep.AR2 = bodies(:,2);
%         new_sweep.amp = guesses(:,1);   new_sweep.lambda = guesses(:,2);   new_sweep.nlambda = guesses(:,3);
    case {'dino', 'sheet'}
...
inputs.accuracy.interpolation.max_iter = 6;  %max # adaptive interpolation iterations before giving up
