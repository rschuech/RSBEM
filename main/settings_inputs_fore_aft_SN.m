...
%           inputs.paths.datfolder = 'E:\Hull\dinoflagellate\hairsheet3\';  
    ...
    case {'CFD01','CFD02','CFD03','CFD04'}
        ...
        inputs.paths.results_file = 'Results_Fore_Aft_SN.mat';
        ...
        inputs.paths.lock_file = 'Fore_Aft_lock'; % to avoid race condition between racks when writing to shared Results file
       ...
       % distcomp.feature( 'LocalUseMpiexec', false ); %fixes bug in parallel toolbox as of 2015a
        inputs.paths.dumpfolder = 'C:\Users\rudi\Desktop\RD\Fore_Aft_SN_dumps\';
...
switch inputs.bugtype
    case 'bacteria'
        load(['../sweeps/','sweep_fore_aft_refined2.mat']);  %contains all new AR1, AR2, amp, lambda, nlambda
