...
sweep_file = ['sweep_temporal_SN_',rack,'_',num2str(num),'.mat'];
...
results_file_name =   ['Results_Temporal_SN_',num,'.mat'];
...
%     end
    ...
    objfun = @(tail) - optimization_wrapper_temporal_SN(AR1, AR2, tail(1), tail(2), max_arclength, results_file, lock_file_name, results_file_name , sweep_tempfile);
