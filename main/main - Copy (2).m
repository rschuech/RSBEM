...
for sweep_i = 1:length(Inputs)
    ...
    if  strcmp(input.bugtype,'bacteria') && input.tail.rotate_tail %to check for possible effect of tail phase angle on calculated diffusivities   %strcmp(input.problemtype,'forced') &&
