...
% options = optimoptions('fmincon','display','iter-detailed','tolfun',2E-5,'FiniteDifferenceStepSize',1E-2);
...
options{9} = optimoptions('patternsearch','cache','on','cachetol',1E-4,'display','iter','InitialMeshSize',0.02, 'AccelerateMesh',true,'maxfunctionevaluations',150, ...
