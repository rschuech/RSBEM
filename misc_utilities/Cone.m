 function [Cone,EndPlate1,EndPlate2] = Cone(X1,X2,R,n,cyl_color,alpha,closed,lines)
%
...
set(Cone,'AmbientStrength',1,'FaceColor',cyl_color,'EdgeColor',cyl_color,'FaceLighting','gouraud','FaceAlpha',alpha);%,'EdgeColor','none')
if closed==1
    set([EndPlate1 EndPlate2],'AmbientStrength',1,'FaceColor',cyl_color,'EdgeColor',cyl_color,'FaceLighting','gouraud','FaceAlpha',alpha);%,'EdgeColor','none')
else
    EndPlate1=[];
    EndPlate2=[];
end
