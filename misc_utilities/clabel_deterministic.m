function hh = clabel_deterministic(cs, varargin)

% despite my best efforts, it still is not deterministic!
% no idea where randomness is coming from, perhaps in original call to
% contour, where it must be buried in shatlab internal code
