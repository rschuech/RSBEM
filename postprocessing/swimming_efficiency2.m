...
AR1_discard = [3.25 3.75 4.25   7.25   1.125 1.25 1.375 1.625 1.75    ];  %  1.125 1.25 1.375 1.625 1.75
...
% files = dir([folder,'Results_1.mat']);
...
%     
   ...
   %%
    ...
    Depvars = {'Power_eff','Dm', 'temporal_SN','temporal_ability','fore_aft_SN','fore_aft_ability','construction'}; %,'tau_a','lambda_a','error_angle'};
     ...
     names = {'Swimming Efficiency','Dispersal','Temporal SN','Fore-Aft SN','Construction Ease','Tumbling Ease','Flagellar Buckling Force mean','Flagellar Buckling Force max','Flagellar Buckling Torque mean','Flagellar Buckling Torque max'};
...
%         pl = plot(best_line.AR1,best_line.AR2,'k-','linewidth',3);
        ...
        clims = [ 0.7  1.0423;       1  4.2894;         1  2.0449;          0.0  6.4;          0.6  1;             0.05  1;    0.9 1.4;                     0.9 1.4;                                                       0.95 12;             0.95 12;];
...
%      print('-dpng','-r500',['E:\Hull\select_dumps\','curvature_improvement','.png']);
...
F = scatteredInterpolant(standardized_X(:), standardized_Y(:), Z(:),method,'none');
