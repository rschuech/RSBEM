...
cvals = { ...
    ...
    [0.4:0.05:1.5],... unweighted int abs mean abs curv  9
...
for m =  [7:15]   % 1:length(Fs) % 5 6  18    22 for Gauss construction   31 for tau_a
    %     switch metrics{m}
    %         case 'uptake'
    %             limits = [1 10; 0 0.985];
    %         otherwise
...
legnames = {'Tumbling Ability','Swimming Efficiency','Chemotactic Signal/Noise','Nutrient Uptake','Shape Construction Cost'};
