...
for i = 1:length(t)
    ...
    if t(i) <= geom.t_min  %must be in starting sphere
        ...
        start_dir = start_der / sqrt(sum(start_der.^2));  %no longer has "speed" but can include that into t parameter
        
        delta = ( t(i) - geom.t_min) *(start_dir);  %what to add to start_pt to get to linearly extrapolated point inside starting sph
    ...
    elseif t(i) > geom.t_transition && t(i) <= geom.t_max
        ...
        end_dir = end_der / sqrt(sum(end_der.^2));
        
        delta = ( t(i) - geom.t_max) *(end_dir);  %what to add to end_pt to get to linearly extrapolated point inside end sph
...
%magnitude of end_der
% mag :=  sqrt(  (-lambda/(2*Pi))^2  + ( -(  -((1/2)*amp1*kE1^2*lambda^2*t_max*  exp(-(1/4)*kE1^2*lambda^2*t_max^2/Pi^2)   /Pi^2   +(1/2)*(amp2-amp1)*kE2^2*lambda^2*(t_max - t_transition)*exp(-(1/4)*kE2^2*lambda^2*(t_max- t_transition)^2/Pi^2)/Pi^2)*sin(-t_max+omega*time)+(amp1*(1-exp(-(1/4)*kE1^2*lambda^2*t_max^2/Pi^2))+(amp2-amp1)*(1-exp(-(1/4)*kE2^2*lambda^2*(t_max-t_transition)^2/Pi^2)))*cos(-t_max+omega*time)  ) )^2 + 0^2 )
%x component of pt
% pt1 := -lambda*t_max/(2*Pi)    +     ( t - t_max) *  (  -lambda/(2*Pi)  ) / mag
%    y component of pt
% pt2 :=  -( ( amp1*(1-exp(-(kE1)^2 * (lambda*t_max/2/Pi)^2)) + (amp2-amp1)*(1 - exp(-(kE2)^2 * (lambda*(t_max - t_transition)/2/Pi)^2)) ) * sin(t_max - omega*time)  )     +     ( t - t_max) *  (  -(  -((1/2)*amp1*kE1^2*lambda^2*t_max*  exp(-(1/4)*kE1^2*lambda^2*t_max^2/Pi^2)   /Pi^2   +(1/2)*(amp2-amp1)*kE2^2*lambda^2*(t_max - t_transition)*exp(-(1/4)*kE2^2*lambda^2*(t_max- t_transition)^2/Pi^2)/Pi^2)*sin(-t_max+omega*time)+(amp1*(1-exp(-(1/4)*kE1^2*lambda^2*t_max^2/Pi^2))+(amp2-amp1)*(1-exp(-(1/4)*kE2^2*lambda^2*(t_max-t_transition)^2/Pi^2)))*cos(-t_max+omega*time)  )   ) / mag
% vel is time derivatives of pt

vel(i,:) = [  0.4e1 * (t - geom.t_max) * geom.lambda / pi * (geom.lambda ^ 2 / pi ^ 2 + 0.4e1 * ((geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * sin(-geom.t_max + geom.omega * time) - (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * cos(-geom.t_max + geom.omega * time)) ^ 2) ^ (-0.3e1 / 0.2e1) * ((geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * sin(-geom.t_max + geom.omega * time) - (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * cos(-geom.t_max + geom.omega * time)) * ((geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * cos(-geom.t_max + geom.omega * time) * geom.omega + (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * sin(-geom.t_max + geom.omega * time) * geom.omega)    ,...
    (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * cos(-geom.t_max + geom.omega * time) * geom.omega - 0.2e1 * (t - geom.t_max) * (-(geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * cos(-geom.t_max + geom.omega * time) * geom.omega - (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * sin(-geom.t_max + geom.omega * time) * geom.omega) * (geom.lambda ^ 2 / pi ^ 2 + 0.4e1 * ((geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * sin(-geom.t_max + geom.omega * time) - (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * cos(-geom.t_max + geom.omega * time)) ^ 2) ^ (-0.1e1 / 0.2e1) + 0.8e1 * (t - geom.t_max) * (-(geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * sin(-geom.t_max + geom.omega * time) + (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * cos(-geom.t_max + geom.omega * time)) * (geom.lambda ^ 2 / pi ^ 2 + 0.4e1 * ((geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * sin(-geom.t_max + geom.omega * time) - (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * cos(-geom.t_max + geom.omega * time)) ^ 2) ^ (-0.3e1 / 0.2e1) * ((geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * sin(-geom.t_max + geom.omega * time) - (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * cos(-geom.t_max + geom.omega * time)) * ((geom.amp(1) * geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max * exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1 + (geom.amp(2) - geom.amp(1)) * geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) * exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1) / pi ^ 2 / 0.2e1) * cos(-geom.t_max + geom.omega * time) * geom.omega + (geom.amp(1) * (0.1e1 - exp(-geom.kE(1) ^ 2 * geom.lambda ^ 2 * geom.t_max ^ 2 / pi ^ 2 / 0.4e1)) + (geom.amp(2) - geom.amp(1)) * (0.1e1 - exp(-geom.kE(2) ^ 2 * geom.lambda ^ 2 * (geom.t_max - geom.t_transition) ^ 2 / pi ^ 2 / 0.4e1))) * sin(-geom.t_max + geom.omega * time) * geom.omega)        ,...
    0 ];
