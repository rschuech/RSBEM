...
% geom.tail.radius = 0.75;  % fat tail


geom.tail.lambda = 22.2;
geom.tail.nlambda = 1.8531 *8;
...
geom.tail.t_transition = 3.324886729350000 ; % with offset
...
geom.tail.translation = [27.019250099175302 0.000000000000004 14.650000000000000]';  % with offset
...
geom.transverse.u_max = 6.130084775427586  ;  % with offset
