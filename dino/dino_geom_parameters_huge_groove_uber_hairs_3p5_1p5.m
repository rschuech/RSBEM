...
geom.tail.t_transition = 4.173965824890192 ; % with offset
...
geom.tail.translation = [30.019250099088325 0.000000000000004 14.650000000000000]';  % with offset
...
geom.transverse.u_max = 6.130084775658204 ;  % with offset
...
geom.transverse.shift = 32.45833333333299;  %gotten from Salome command line, need to add shift_x to Parameters.txt     with offset
...
geom.hairs.Coplanar_Hairs.h_max = 3.5;
