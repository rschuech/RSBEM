...
for time = T
    ...
    arclength(c) = integral(integrand_fun,0,geom.t_max,'abstol',1E-10,'reltol',1E-6);
end
...
%%
arclength_goal = 54.2;  %solve for nlambda needed to generate this arclength


objfun = @(nlambda) tail_arclength(geom, nlambda) - arclength_goal;

nlambda = fzero(objfun, 1)
